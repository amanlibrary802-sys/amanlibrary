...
export default function ThreeWeekAlerts() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-amiri font-bold text-primary mb-2">3rd Week Alerts</h1>
        <p className="text-primary/60 font-medium">Students who have held books for 21 days or more (Officially Due).</p>
      </div>
              ...
              <tr key={alertItem.transaction_id} className="hover:bg-cream/30 transition-colors">
                ...
                <td className="px-8 py-6 text-right actions-cell" data-label="Action">
                  <a
                    ...
                    className="w-auto bg-red-50 text-red-600 border border-red-100 px-4 py-2 h-9 rounded-xl font-bold text-[11px] hover:bg-red-600 hover:text-white transition-all flex items-center justify-center gap-1.5 ml-auto shadow-sm"
                  >
