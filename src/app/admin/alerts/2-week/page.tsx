...
export default function TwoWeekReminders() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-amiri font-bold text-slate-200 mb-2">2-Week Reminders</h1>
        <p className="text-slate-400 font-medium">Students who have held books for 14-20 days (1 week left).</p>
      </div>
              ...
              <tr key={alertItem.transaction_id} className="hover:bg-slate-800/50 transition-colors">
                <td className="px-8 py-6" data-label="Student">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-blue-500/10 flex items-center justify-center text-slate-200 shrink-0">
                ...
                <td className="px-8 py-6 text-right actions-cell" data-label="Action">
                  <a
                    ...
                    className="w-auto bg-amber-500/10 text-amber-400 border border-amber-500/20 px-4 py-2 h-9 rounded-xl font-bold text-[11px] hover:bg-amber-600 hover:text-white transition-all flex items-center justify-center gap-1.5 ml-auto shadow-sm"
                  >
